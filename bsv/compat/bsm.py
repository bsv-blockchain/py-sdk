...
from bsv.utils import unsigned_to_varint, serialize_ecdsa_der, deserialize_ecdsa_der
import base64
...
def verify(
    ...
    if isinstance(sig, str):
        from bsv.utils import unstringify_ecdsa_recoverable, deserialize_ecdsa_recoverable
