...
- [ ] CI/wheel ビルド (0E) — manylinux/macOS/Windows wheel 自動ビルド
- [ ] Python-only / C パス等価性テスト — エラーメッセージ差異の網羅的検証
...
**進捗: Phase 0+1+2+3(3a+3b+3b++3c) + SE統合 + Phase 4(4.1-4.3) + ファズ/メモリテスト 完了 (2026-07-01)**
**テスト: 3,430 passed + 46 fuzz, 259 skipped**
**残り: Phase 4.4 (context_randomize 定期呼び出し)、4.5 (Schnorr API)**
**未着手横断タスク: CI/wheel (0E)、等価性テスト**
