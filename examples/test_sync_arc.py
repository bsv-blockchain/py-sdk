...
from bsv import ARC, P2PKH, BroadcastResponse, PrivateKey, Transaction, TransactionInput, TransactionOutput
...
def main():
    ...
    tx = Transaction(
        ...
        [TransactionOutput(locking_script=P2PKH().lock("1QnWY1---------3DDeWUC2VLn"), change=True)],
    )
