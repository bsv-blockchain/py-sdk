...
SPEND_VALID_CASES = [
    ["", "740087", "Test the test: we should have an empty stack after scriptSig evaluation"],
    ...
    ["04ffffff7f", "8b05000000800087", "We can do math on 4-byte integers, and compare 5-byte ones"],
    ...
    ["00", "a9", "test"],
    ["00", "aa", "test"],
    ["", "000000ae69740087", "CHECKMULTISIG is allowed to have zero keys and/or sigs"],
    ["", "000000af740087", "test"],
    ...
    ["00", "2102865c40293a680cb9c020e7b1e106d8c1916d3cef99aa431a56d253e69256dac0ac91", "test"],
    # [
    #    "0000",
