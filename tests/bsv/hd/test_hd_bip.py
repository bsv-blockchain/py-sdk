...
from bsv.hd.bip32 import bip32_derive_xkeys_from_xkey, bip32_derive_xprvs_from_mnemonic, master_xprv_from_seed
...
def test_key_derivation_consistency():
    ...
    keys_from_bip32_mnemonic = bip32_derive_xprvs_from_mnemonic(
        test_mnemonic, 0, 2, path=BIP32_DERIVATION_PATH, change=0
    )
    ...
    keys_from_bip32_mnemonic = bip32_derive_xprvs_from_mnemonic(
        test_mnemonic, 0, 2, path=BIP44_DERIVATION_PATH, change=0
    )
    keys_from_bip44_mnemonic = bip44_derive_xprvs_from_mnemonic(
        test_mnemonic, 0, 2, path=BIP44_DERIVATION_PATH, change=0
    )
