...
from bsv.script.interpreter.operations import (
    opcode_1add, opcode_1sub, opcode_negate, opcode_abs, opcode_not,
    opcode_0notequal, opcode_add, opcode_sub, opcode_mul, opcode_div,
    opcode_mod, opcode_booland, opcode_boolor, opcode_numequal,
    opcode_numequal_verify, opcode_numnotequal, opcode_lessthan,
    opcode_greaterthan, opcode_lessthanorequal, opcode_greaterthanorequal,
    opcode_min, opcode_max, opcode_within
)
...
class TestArithmeticOpcodes:
    ...
    def test_opcode_1add_success(self):
        ...
        err = opcode_1add(pop, self.thread)
    ...
    def test_opcode_1add_stack_underflow(self):
    ...
    def test_opcode_1sub_success(self):
        ...
        err = opcode_1sub(pop, self.thread)
    ...
    def test_opcode_negate_success(self):
        ...
        err = opcode_negate(pop, self.thread)
    ...
    def test_opcode_negate_zero(self):
    ...
    def test_opcode_abs_success_positive(self):
        ...
        err = opcode_abs(pop, self.thread)
    ...
    def test_opcode_abs_success_negative(self):
    ...
    def test_opcode_not_success_zero(self):
        ...
        err = opcode_not(pop, self.thread)
    ...
    def test_opcode_not_success_nonzero(self):
    ...
    def test_opcode_0notequal_success_zero(self):
        ...
        err = opcode_0notequal(pop, self.thread)
    ...
    def test_opcode_0notequal_success_nonzero(self):
    ...
    def test_opcode_add_success(self):
        ...
        err = opcode_add(pop, self.thread)
    ...
    def test_opcode_add_stack_underflow(self):
    ...
    def test_opcode_sub_success(self):
        ...
        err = opcode_sub(pop, self.thread)
    ...
    def test_opcode_booland_success(self):
        ...
        err = opcode_booland(pop, self.thread)
    ...
    def test_opcode_booland_false(self):
    ...
    def test_opcode_boolor_success(self):
        ...
        err = opcode_boolor(pop, self.thread)
    ...
    def test_opcode_boolor_both_false(self):
    ...
    def test_opcode_numequal_success_equal(self):
        ...
        err = opcode_numequal(pop, self.thread)
    ...
    def test_opcode_numequal_success_not_equal(self):
    ...
    def test_opcode_lessthan_success(self):
        """Test OP_LESSTHAN."""
        ...
        err = opcode_lessthan(pop, self.thread)
    ...
    def test_opcode_greaterthan_success(self):
        """Test OP_GREATERTHAN."""
        ...
        err = opcode_greaterthan(pop, self.thread)
    ...
    def test_opcode_min_success(self):
        """Test OP_MIN."""
        # Setup: push 10 and 5
        self.thread.dstack.push_int(ScriptNumber(10))
        self.thread.dstack.push_int(ScriptNumber(5))
        ...
        err = opcode_min(pop, self.thread)
    ...
    def test_opcode_max_success(self):
        """Test OP_MAX."""
        # Setup: push 10 and 5
        self.thread.dstack.push_int(ScriptNumber(10))
        self.thread.dstack.push_int(ScriptNumber(5))
        ...
        err = opcode_max(pop, self.thread)
    ...
    def test_opcode_within_success_inside(self):
        ...
        err = opcode_within(pop, self.thread)
    ...
    def test_opcode_within_success_outside(self):
